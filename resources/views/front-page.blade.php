...
@section('front-content')
	...
	<div class="container">
		<section id="hero" class="jumbotron text-center my-5">
			<h1 class="text-muted">Login first here</h1>
			<button class="btn btn-info btn-lg text-white"><a href="{{ route('login') }}">Login</a></button>
		</section>
		<section id="clinic">
			<div class="container">

			...
			<div class="card-body">
					...
					<div class="form-row">
						...
						<div class="form-group col-md-4">
							...
							<p class="h6">{{ ( !empty(@$employee->spouse_name) ) ? Carbon\carbon::parse(@$employee->date_of_marriage)->format('M d, Y') : "None" }}</p>
						</div>
					</div>
							...
							<div class="row">
								<div class="col-12 form-row">
									<div class="form-group col-md-4">
										...
										<p class="h6">{{ ucfirst($children[0]) }}</p>
									</div>
									<div class="form-group col-md-4">
									...
									<div class="form-group col-md-4">
										...
										<p class="h6">{{ ucfirst($children[2]) }}</p>
									</div>
								</div>
							</div>

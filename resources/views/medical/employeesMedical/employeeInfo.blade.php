	...
	<div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="{{ route('medical.store', ['employee' => $employee->id]) }}">
					@csrf
					...
					<div id="meds" class="form-row">
						...
						<input type="number" name="quantity[0][0]" class="form-control" {{-- min="0" max="{{ $gens->brands }}" --}} placeholder="Quantity">
						</div>
					</div>
